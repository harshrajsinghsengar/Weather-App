...
const API_KEY = "9cea108c3f76430ba5581717241409";
...
const weatherCodes = {
    ...
    snow: [1066, 1069, 1972, 1114, 1117, 1204, 1207, 1210, 1213, 1216, 1219, 1222, 1225, 1237, 1249, 1252, 1255, 1258, 1261, 1264, 1279, 1282],
...
const displayHourlyForecast = (hourlyData) => {
    ...
    const next25Hours = currentHour + 24 * 60 * 60 * 1000;

    //Filter the hourly data to include only the next 24 hours
    const next24HoursData = hourlyData.filter(({ time }) => {
        const forecastTime = new Date(time).getTime();
        return forecastTime >= currentHour && forecastTime <= next25Hours;
    });
    ...
    hourlyWeatherDiv.innerHTML = next24HoursData.map(item => {
        ...
        return `<li class="weather-item" 
                <p class="time">${time}</p>
                <img src="/Users/hrs/Weather App/icons/${weatherIcon}.svg" class="weather-icon">
...
const getWeatherDetails = async (API_URL) => {
    ...
    try{
        ...
        currentWeatherDiv.querySelector(".weather-icon").src = `/Users/hrs/Weather App/icons/${weatherIcon}.svg`;
